...
const Home=()=> {   
    ...
    const fetchData = async () => {
      const res=await axios.get('https://airline-i9jn.onrender.com/retrieve_flight');
    ...
    const updateData = async (id) => {
      console.log(id)
      const res = await axios.put(`https://airline-i9jn.onrender.com/${id}`, formData)
      fetchData()
      console.log(res.data)
    }
    ...
    const deleteData = async (id) => {
      console.log(id)
      const res = await axios.delete(`https://airline-i9jn.onrender.com/users/${id}`)
      fetchData()
      console.log(res.data)
    }
